...
from .views import (
    ...
    # auth/register - KR 21/08/2025
    register,

    # mood endpoints (JWT) - KR 02/09/2025
    mood_discover, mood_refresh_snapshot,

    # admin mood config (pins/keywords/seed) - KR 02/09/2025
    moods_config, mood_pins_mutate, mood_keywords_mutate, mood_seed_from_movie,
)
...
urlpatterns = [
    ...
    # --- Admin mood config (protected) --- KR 02/09/2025
